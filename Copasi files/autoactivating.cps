...
<!-- generated with COPASI 4.5 (Build 30) (http://www.copasi.org) at 2011-09-07 12:52:19 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="1" versionMinor="0" versionDevel="30">
  ...
  <Model key="Model_1" name="Autoactivating Gene" timeUnit="min" volumeUnit="dimensionless" quantityUnit="#" type="deterministic">
    <Comment>
    ...
    <ListOfMetabolites>
      ...
      <Metabolite key="Metabolite_1" name="P" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
      <Metabolite key="Metabolite_2" name="PDIM" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
      <Metabolite key="Metabolite_3" name="C" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
      <Metabolite key="Metabolite_4" name="PTOT" simulationType="assignment" compartment="Compartment_0">
        <Expression>
          &lt;CN=Root,Model=Autoactivating Gene,Vector=Compartments[compartment],Vector=Metabolites[P],Reference=ParticleNumber&gt;+2*&lt;CN=Root,Model=Autoactivating Gene,Vector=Compartments[compartment],Vector=Metabolites[PDIM],Reference=ParticleNumber&gt;
        </Expression>
      </Metabolite>
    </ListOfMetabolites>
    <ListOfReactions>
      <Reaction key="Reaction_0" name="Basal transcription" reversible="false">
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_740" name="k1" value="0.03"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_1" name="Activated transcription" reversible="false">
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_739" name="k1" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_2" name="DNA-TF dimer binding" reversible="false">
        <ListOfSubstrates>
          <Substrate metabolite="Metabolite_0" stoichiometry="1"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_726" name="k1" value="0.01"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_3" name="DNA-TF dimer unbinding" reversible="false">
        <ListOfSubstrates>
          <Substrate metabolite="Metabolite_3" stoichiometry="1"/>
        </ListOfSubstrates>
        <ListOfProducts>
        ...
        <ListOfConstants>
          <Constant key="Parameter_725" name="k1" value="0.06"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_4" name="Protein degradation" reversible="false">
        <ListOfSubstrates>
      ...
      <Reaction key="Reaction_5" name="Dimer degradation" reversible="false">
        <ListOfSubstrates>
          <Substrate metabolite="Metabolite_2" stoichiometry="1"/>
        </ListOfSubstrates>
        <ListOfConstants>
      ...
      <Reaction key="Reaction_6" name="Dimer association" reversible="false">
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_407" name="k1" value="6e-05"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_7" name="Dimer dissociation" reversible="false">
        <ListOfSubstrates>
          <Substrate metabolite="Metabolite_2" stoichiometry="1"/>
        </ListOfSubstrates>
        <ListOfProducts>
        ...
        <ListOfConstants>
          <Constant key="Parameter_406" name="k1" value="0"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_12" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      <Problem>
        ...
        <Parameter name="Duration" type="float" value="200000"/>
  ...
  <ListOfPlots>
    <PlotSpecification name="Stochastic: Particle Numbers" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="D.ParticleNumber" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Autoactivating Gene,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Autoactivating Gene,Vector=Compartments[compartment],Vector=Metabolites[D],Reference=ParticleNumber"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="P.ParticleNumber" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Autoactivating Gene,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Autoactivating Gene,Vector=Compartments[compartment],Vector=Metabolites[P],Reference=ParticleNumber"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="PDIM.ParticleNumber" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Autoactivating Gene,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Autoactivating Gene,Vector=Compartments[compartment],Vector=Metabolites[PDIM],Reference=ParticleNumber"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="C.ParticleNumber" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Autoactivating Gene,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Autoactivating Gene,Vector=Compartments[compartment],Vector=Metabolites[C],Reference=ParticleNumber"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="PTOT.ParticleNumber|Time" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Autoactivating Gene,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Autoactivating Gene,Vector=Compartments[compartment],Vector=Metabolites[PTOT],Reference=ParticleNumber"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
    <PlotSpecification name="PTOT histogram" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="Histogram: PTOT.ParticleNumber" type="Histogram1DItem">
          <Parameter name="Recording Activity" type="string" value="during"/>
          <Parameter name="increment" type="float" value="5"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Autoactivating Gene,Vector=Compartments[compartment],Vector=Metabolites[PTOT],Reference=ParticleNumber"/>
          </ListOfChannels>
        </PlotItem>
    ...
    <PlotSpecification name="Deterministic: Particle Numbers" type="Plot2D" active="0">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="D.ParticleNumber" type="Curve2D">
        ...
        <PlotItem name="PTOT.ParticleNumber" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Autoactivating Gene,Reference=Time"/>
  ...
  <GUI>
    <ListOfSliders>
      <Slider key="Slider_0" associatedEntityKey="Model_1" objectCN="CN=Root,Model=Autoactivating Gene,Vector=Reactions[Dimer association],ParameterGroup=Parameters,Parameter=k1,Reference=Value" objectType="float" objectValue="5.997e-05" minValue="1e-05" maxValue="0.0002" tickNumber="1000" tickFactor="100" scaling="linear"/>
    </ListOfSliders>
  </GUI>
</COPASI>
