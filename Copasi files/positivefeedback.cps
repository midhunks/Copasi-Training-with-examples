...
<!-- generated with COPASI 4.5 (Build 30) (http://www.copasi.org) at 2011-09-03 20:47:14 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="1" versionMinor="0" versionDevel="30">
  <ListOfFunctions>
    ...
    <Function key="Function_45" name="Rate Law for y production" type="UserDefined" reversible="unspecified">
      <Expression>
        delta*x
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_260" name="delta" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_243" name="x" order="1" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_46" name="Rate Law for x production" type="UserDefined" reversible="unspecified">
      <Expression>
        lambda*y^m/(y^m+theta^m)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_246" name="lambda" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_250" name="y" order="1" role="modifier"/>
        <ParameterDescription key="FunctionParameter_261" name="m" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_263" name="theta" order="3" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_47" name="Objective Function" type="Expression">
      <Expression>
        
      </Expression>
    </Function>
  </ListOfFunctions>
  <Model key="Model_1" name="Positive feedback" timeUnit="s" volumeUnit="ml" quantityUnit="mmol" type="deterministic">
    <Comment>
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="x production" reversible="false">
        <ListOfProducts>
        ...
        <ListOfConstants>
          <Constant key="Parameter_740" name="lambda" value="1"/>
          <Constant key="Parameter_739" name="m" value="3"/>
          <Constant key="Parameter_726" name="theta" value="0.5"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_1" name="y production" reversible="false">
        <ListOfProducts>
        ...
        <ListOfConstants>
          <Constant key="Parameter_725" name="delta" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_2" name="x decay" reversible="false">
        <ListOfSubstrates>
          <Substrate metabolite="Metabolite_0" stoichiometry="1"/>
        </ListOfSubstrates>
        <ListOfConstants>
          <Constant key="Parameter_92" name="k1" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_3" name="y decay" reversible="false">
        <ListOfSubstrates>
    ...
    <InitialState type="initialState">
      0 3.6132849e+20 3.011070750000001e+20 1
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_15" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <Parameter name="ObjectiveFunction" type="key" value="Function_47"/>
    ...
    <Task key="Task_16" name="Parameter Estimation" type="parameterFitting" scheduled="false" updateModel="false">
      <Report reference="Report_11" target="" append="0"/>
      <Problem>
        <Parameter name="Maximize" type="bool" value="0"/>
        <ParameterGroup name="OptimizationItemList">
        </ParameterGroup>
  ...
  <ListOfPlots>
    <PlotSpecification name="[x,y](t)" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="[x]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Positive feedback,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Positive feedback,Vector=Compartments[cell],Vector=Metabolites[x],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[y]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Positive feedback,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Positive feedback,Vector=Compartments[cell],Vector=Metabolites[y],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
